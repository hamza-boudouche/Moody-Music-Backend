...
Revision ID: 7b894978689b
Revises: e2f9fc6aae0c
Create Date: 2021-12-11 21:16:08.415933
...
revision = '7b894978689b'
down_revision = 'e2f9fc6aae0c'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('preferredGenreid', sa.Integer(), nullable=True),
    sa.Column('commonMoodid', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['commonMoodid'], ['mood.id'], ),
    sa.ForeignKeyConstraint(['preferredGenreid'], ['genre.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
